...
public class Token {
  ...
  public enum Kind {
    ...
    public static final Pattern isFloat = Pattern.compile(
      "^-?[0-9]*\\.[0-9]+$"
    );
    public static final Pattern isIdent = Pattern.compile(
      "^[a-zA-Z_$][a-zA-Z0-9_$]*$"
    );
  ...
  public Token(String lexeme, int lineNum, int charPos) {
    ...
    this.lexeme =
      (this.kind != Kind.ERROR ? lexeme : "Unrecognized lexeme: " + lexeme);
