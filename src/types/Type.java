...
public abstract class Type {
  ...
  public Type mod(Type that) {
    if(!this.getClass().equals(that.getClass()) || this.getClass().equals(BoolType.class) || that.getClass().equals(BoolType.class)){
      return new ErrorType("Cannot modulo " + this + " with " + that + ".");
    }
    return that;
  }
  ...
  public Type and(Type that) {
    if(!this.getClass().equals(BoolType.class) || !that.getClass().equals(BoolType.class)){
  ...
  public Type assign(Type source) {
    if(!this.getClass().equals(source.getClass()) || this.getClass().equals(VoidType.class) || source.getClass().equals(VoidType.class)){
