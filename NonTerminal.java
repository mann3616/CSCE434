...
public enum NonTerminal {
    ...
    ADD_EXPRESSION(new HashSet<Token.Kind>() {
        private static final long serialVersionUID = 1L;
        {
            //throw new RuntimeException("implement expression FIRST set");
        }
    }),
    MULT_EXPRESSION(new HashSet<Token.Kind>() {
        private static final long serialVersionUID = 1L;
        {
            //throw new RuntimeException("implement expression FIRST set");
        }
    }),
    POW_EXPRESSION(new HashSet<Token.Kind>() {
        private static final long serialVersionUID = 1L;
        {
            //throw new RuntimeException("implement expression FIRST set");
        }
    }),
    RELATION_EXPRESSION(new HashSet<Token.Kind>() {
        private static final long serialVersionUID = 1L;
        {
            //throw new RuntimeException("implement term FIRST set");
        }
    }),
    GROUP_EXPRESSION(new HashSet<Token.Kind>() {
        private static final long serialVersionUID = 1L;
        {
            //throw new RuntimeException("implement expression FIRST set");
        }
